...
class Hotels_form(forms.Form):
	...
	hotel_name_certification = forms.CharField(widget=forms.TextInput(attrs={'placeholder': 'Name Certification', 'class': 'form-control form-control-user'}))
	...
	login = forms.CharField(required=False, widget=forms.TextInput(attrs={'placeholder': 'Host login', 'class': 'form-control form-control-user'}))
	password = forms.CharField(required=False, max_length=200, widget=forms.PasswordInput(attrs={'class': 'form-control form-control-user', 'placeholder': 'Host password'}))
...
class Hotel_User_form(forms.Form):
	organization = forms.CharField(max_length=20, widget=forms.TextInput(attrs={'placeholder': 'Organization', 'class': 'form-control form-control-user' , "id": "organization"}))
